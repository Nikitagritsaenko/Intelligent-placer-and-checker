...
- Нет размытий, разрешение не менее 96 dpi
...
Такая точность получается из-за не всегда верной классификации предметов. Рассмотрим дополнительно сам алгоритм упаковки, подавая на вход ему верный результат классификации.

Всего тестов: 11
* Верных ответов: 10 (90.9%)
* Ложных ответов: 1 (9.1%)

Видим, что точность значительно возросла. Таким образом, у нас есть некоторые проблемы в части классификации, однако алгоритм упаковки достаточно хорош!
