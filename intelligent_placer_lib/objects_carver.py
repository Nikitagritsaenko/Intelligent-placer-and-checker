...
predefined_convex_hulls = [
    [get_rect([600, 1300]), "плеер"],
    [get_rect([600, 1300]), "плеер"],
    [get_rect([600, 1300]), "плеер"],
    [[[400, 0], [0, 500], [250, 1700], [1150, 1550], [900, 220]], "мышь"],
    [[[400, 0], [0, 500], [250, 1700], [1150, 1550], [900, 220]], "мышь"],
    [[[400, 0], [0, 500], [250, 1700], [1150, 1550], [900, 220]], "мышь"],
    [get_rect([730, 1170]), "проездной"],
    [get_rect([730, 1170]), "проездной"],
    [get_rect([730, 1170]), "проездной"],
    [get_ideal_polygon(265, 40), "масло для губ"],
    [get_ideal_polygon(265, 40), "масло для губ"],
    [get_ideal_polygon(265, 40), "масло для губ"],
    [get_rect([1050, 300]), "флешка"],
    [get_rect([1050, 300]), "флешка"],
    [get_rect([1050, 300]), "флешка"],
    [[[600, 0], [50, 290], [50, 850], [270, 1370], [900, 1160], [1170, 600]], "рулетка"],
    [[[600, 0], [50, 290], [50, 850], [270, 1370], [900, 1160], [1170, 600]], "рулетка"],
    [get_ideal_polygon(500, 40), "йо-йо"],
    [get_ideal_polygon(500, 40), "йо-йо"],
    [get_ideal_polygon(500, 40), "йо-йо"],
    [get_ideal_polygon(500, 40), "йо-йо"],
    [[[250, 0], [50, 50], [0, 200], [180, 630], [380, 640], [530, 250], [470, 50]], "точилка"],
    [[[250, 0], [50, 50], [0, 200], [180, 630], [380, 640], [530, 250], [470, 50]], "точилка"],
    [[[250, 0], [50, 50], [0, 200], [180, 630], [380, 640], [530, 250], [470, 50]], "точилка"],
    [[[250, 0], [50, 50], [0, 200], [180, 630], [380, 640], [530, 250], [470, 50]], "точилка"],
    [[[250, 0], [50, 50], [0, 200], [180, 630], [380, 640], [530, 250], [470, 50]], "точилка"],
    ...
    [[[250, 0], [50, 50], [0, 200], [180, 630], [380, 640], [530, 250], [470, 50]], "точилка"],
    [[[250, 0], [50, 50], [0, 200], [180, 630], [380, 640], [530, 250], [470, 50]], "точилка"],
    [get_rect([800, 500]), "футляр для наушников"],
    [get_rect([800, 500]), "футляр для наушников"],
    [get_rect([800, 500]), "футляр для наушников"],
    [get_rect([800, 500]), "футляр для наушников"]
]
...
def thresh_callback(src, threshold):
    ...
    __, contours, hierarchy = cv2.findContours(closed, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
